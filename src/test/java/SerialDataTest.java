...
public class SerialDataTest extends BaseSerialTest{
	 ...
	 */		
	@Test
	public void openPortWithoutExclusiveOwnershipTest() throws SerialComException, InterruptedException{
		
		LOG.debug("openPortWithoutExclusiveOwnershipTest()");
