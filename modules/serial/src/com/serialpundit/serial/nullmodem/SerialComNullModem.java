...
public final class SerialComNullModem {
	...
	public int registerTTY2COMHotPlugEventListener(final Itty2comHotPlugListener hotPlugListener, String deviceNode) 
		...
		synchronized(lockB) {
			...
			if(opaqueHandle < 0) {
				throw new SerialComException("Could not register virtual serial device hotplug listener. Please retry !");
			}
		}
	...
	public boolean unregisterTTY2COMHotPlugEventListener(final int opaqueHandle) throws SerialComException {
		...
		synchronized(lockB) {
			...
			if(ret < 0) {
				throw new SerialComException("Can not unregister virtual serial device hotplug listener. Please retry !");
			}
		}
