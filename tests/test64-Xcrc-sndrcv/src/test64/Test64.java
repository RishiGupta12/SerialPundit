...
public class Test64 implements ISerialComXmodemProgress {
	...
	public static Test64 test64 = new Test64();
	...
	public static void main(String[] args) {
		try {
			...
			Executors.newSingleThreadExecutor().execute(new Runnable() {
				...
				public void run() {
					try {
						...
						Thread.sleep(1000);
						boolean status1 = scm.sendFile(handle1, f, FTPPROTO.XMODEM, FTPVAR.CRC, true, test64, null);
			...
			boolean status2 = scm.receiveFile(handle2, new File(rcvdiry1), FTPPROTO.XMODEM, FTPVAR.CRC, true, test64, null);
			...
			Executors.newSingleThreadExecutor().execute(new Runnable() {
				...
				public void run() {
					try {
						...
						Thread.sleep(1000);
						boolean status3 = scm.sendFile(handle3, f, FTPPROTO.XMODEM, FTPVAR.CRC, false, test64, null);
			...
			boolean status4 = scm.receiveFile(handle4, new File(rcvdiry2), FTPPROTO.XMODEM, FTPVAR.CRC, false, test64, null);
			...
			Executors.newSingleThreadExecutor().execute(new Runnable() {
				...
				public void run() {
					try {
						...
						Thread.sleep(1000);
						boolean status5 = scm.sendFile(handle5, f, FTPPROTO.XMODEM, FTPVAR.CRC, false, test64, null);
			...
			boolean status6 = scm.receiveFile(handle6, new File(rcvdiry3), FTPPROTO.XMODEM, FTPVAR.CRC, false, test64, null);
			...
			boolean status7 = scm.receiveFile(handle7, new File(rcvdiry4), FTPPROTO.XMODEM, FTPVAR.CRC, false, test64, null);
