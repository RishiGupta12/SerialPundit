...
public class Test91 implements ISerialComYmodemProgress {
	...
	public static Test91 test91 = new Test91();
	...
	public static void main(String[] args) {
		try {
			...
			Executors.newSingleThreadExecutor().execute(new Runnable() {
				...
				public void run() {
					try {
						...
						Thread.sleep(500);
						boolean status1 = scm.sendFile(handle1, f, FTPPROTO.YMODEM, FTPVAR.VARG, true, test91, null);
			...
			boolean status2 = scm.receiveFile(handle2, new File(rcvdiry1), FTPPROTO.YMODEM, FTPVAR.VARG, true, test91, null);
			...
			Executors.newSingleThreadExecutor().execute(new Runnable() {
				...
				public void run() {
					try {
						...
						f[2] = new File(sndtxt4);
						Thread.sleep(500);
						boolean status3 = scm.sendFile(handle3, f, FTPPROTO.YMODEM, FTPVAR.VARG, false, test91, null);
			...
			boolean status4 = scm.receiveFile(handle4, new File(rcvdiry2), FTPPROTO.YMODEM, FTPVAR.VARG, false, test91, null);
			...
			Executors.newSingleThreadExecutor().execute(new Runnable() {
				...
				public void run() {
					try {
						...
						Thread.sleep(500);
						boolean status5 = scm.sendFile(handle5, f, FTPPROTO.YMODEM, FTPVAR.VARG, false, test91, null);
			...
			boolean status6 = scm.receiveFile(handle6, new File(rcvdiry3), FTPPROTO.YMODEM, FTPVAR.VARG, false, test91, null);
