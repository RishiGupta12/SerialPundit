...
public final class FlowControl {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			scnm.createStandardNullModemPair(-1, -1);
			Thread.sleep(100);
			ports = scnm.getLastNullModemPairNodes();
			Thread.sleep(200);
			...
			long handle11 = scm.openComPort(ports[4], true, true, false);
			...
			Reader r1 = new Reader(scm, handle11);
			t = new Thread(r1);
			t.start();
			...
			long handle12 = scm.openComPort(ports[4], true, true, true);
			...
			Reader r2 = new Reader(scm, handle12);
			t = new Thread(r2);
			t.start();
