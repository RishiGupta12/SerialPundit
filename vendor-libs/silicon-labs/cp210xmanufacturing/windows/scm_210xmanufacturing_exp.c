...
void throw_serialcom_exception(JNIEnv *env, int type, int error_code, const char *msg) {
	...
	case 2:
		...
		switch (error_code) {
		case CP210x_DEVICE_NOT_FOUND: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_DEVICE_NOT_FOUND");
			break;
		case CP210x_INVALID_HANDLE: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_INVALID_HANDLE");
			break;
		case CP210x_INVALID_PARAMETER: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_INVALID_PARAMETER");
			break;
		case CP210x_DEVICE_IO_FAILED: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_DEVICE_IO_FAILED");
			break;
		case CP210x_FUNCTION_NOT_SUPPORTED: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_FUNCTION_NOT_SUPPORTED");
			break;
		case CP210x_GLOBAL_DATA_ERROR: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_GLOBAL_DATA_ERROR");
			break;
		case CP210x_FILE_ERROR: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_FILE_ERROR");
			break;
		case CP210x_COMMAND_FAILED: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_COMMAND_FAILED");
			break;
		case CP210x_INVALID_ACCESS_TYPE: _snprintf_s(buffer, 256, 256, "%s\0", "CP210x_INVALID_ACCESS_TYPE");
			break;
