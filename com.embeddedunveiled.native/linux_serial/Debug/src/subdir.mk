...
C_SRCS += \
../src/unix_like_exception.c \
../src/unix_like_list_usb.c \
...
OBJS += \
./src/unix_like_exception.o \
./src/unix_like_list_usb.o \
...
C_DEPS += \
./src/unix_like_exception.d \
./src/unix_like_list_usb.d \
...
src/%.o: ../src/%.c
	...
	gcc -I/home/r/packages/jdk1.7.0_75/include -O2 -Wall -c -fmessage-length=0 -m64 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
