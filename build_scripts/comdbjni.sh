...
set -e
javah -jni -d "$PROJECT_ROOT_DIR_PATH/../sp-native/lib-comdb" -classpath $PROJECT_ROOT_DIR_PATH/modules/serial/src com.serialpundit.serial.internal.SerialComDBReleaseJNIBridge
