...
set -e
javah -jni -d $PROJECT_ROOT_DIR_PATH/vendor-libs/ftdi/d2xx -classpath $PROJECT_ROOT_DIR_PATH/com.embeddedunveiled.serial/src com.embeddedunveiled.serial.internal.SerialComFTDID2XXJNIBridge
