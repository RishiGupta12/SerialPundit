...
set -e
javah -jni -d "$PROJECT_ROOT_DIR_PATH/../lib-vendor/silicon-labs/cp210xruntime" -classpath $PROJECT_ROOT_DIR_PATH/com.embeddedunveiled.serial/src com.embeddedunveiled.serial.internal.SerialComCP210xRuntimeJNIBridge
