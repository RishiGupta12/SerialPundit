...
set -e
javah -jni -d "$PROJECT_ROOT_DIR_PATH/../lib-vendor/microchip/simpleio" -classpath $PROJECT_ROOT_DIR_PATH/com.embeddedunveiled.serial/src com.embeddedunveiled.serial.internal.SerialComMCHPSIOJNIBridge
