 ...
 * @author Rishi Gupta
 */
public final class SerialComYModem {
    ...
    private ISerialComYmodemProgress progressListener;
     ...
     */
    public SerialComYModem(SerialComManager scm, long handle, File fileToProcess, boolean textMode,
            ISerialComYmodemProgress progressListener, SerialComXModemAbort transferState, int osType) {
        this.scm = scm;
        this.handle = handle;
