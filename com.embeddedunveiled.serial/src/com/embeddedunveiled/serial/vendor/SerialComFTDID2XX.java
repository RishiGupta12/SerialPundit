 ...
 * <github repository>/tools-and-utilities/99-scm-extra-udev.rules</p>
 *
 ...
 * <github repository>/tools-and-utilities/99-scm-ftdi-d2xx.rules</p></li>
 * 
 * <li>The application notes for FTDI devices are here : http://www.ftdichip.com/Support/Documents/AppNotes.htm</li>
 * 
 * <li><p>SCM version 1.0.4 is linked to d2xx 1.3.6 version for Linux, 2.12.06 for Windows and 1.2.2 for Mac os x.</p></li>
 * </ul>
 * 
 * @author Rishi Gupta
 */
