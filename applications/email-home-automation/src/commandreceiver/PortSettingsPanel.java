 ...
 * Author : Rishi Gupta
 * 
 * innerJPanel file is part of 'serial communication manager' library.
 * Copyright (C) <2014-2016>  <Rishi Gupta>
 *
 * innerJPanel 'serial communication manager' is free software: you can redistribute it and/or modify
